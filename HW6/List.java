            ...
            for(int i = 0; i < array.length; i++) {
                if(array[i] != null) {
                    ...
                    while(current != null) {
                        ...
                        LinkedListNode newNode = newArray[newIndex].getHead();
                        while(newNode != null) {
                            if(newNode.getData().equals(current.getData()))
                                newNode.setEdgeWeight(current.getEdgeWeight());
                        }
                        current = current.getNext();
                    }
                }
